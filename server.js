...
const lang = {
 ...
 'hokkien':{
     'p':{IPA: 'f', Symbols: 'f/ㄈ', Examples: '客'},
     'pʰ':{IPA: 'h', Symbols: 'h/ㄏ', Examples: '虎'},
     'b':{IPA: 'j', Symbols: 'j/一', Examples: '月'},
     'm':{IPA: 'k', Symbols: 'g-/ㄍ', Examples: '家'},
     't':{IPA: 'k̚', Symbols: '-k/-ㄎ', Examples: '識'},
     'tʰ':{IPA: 'kʰ', Symbols: 'k-/ㄎ-', Examples: '卡'},
     'l':{IPA: 'kʷ', Symbols: 'gw/ㄍㄨ', Examples: '瓜'},
     'n':{IPA: 'kʷʰ', Symbols: 'kw/ㄎㄨ', Examples: '誇'},
     'k':{IPA: 'l', Symbols: 'l/ㄌ', Examples: '落'},
     'kʰ':{IPA: 'm̩', Symbols: 'm/ㄇ', Examples: '莫/唔'},
     'g':{IPA: 'n', Symbols: 'n/ㄋ', Examples: '男'},
     'ŋ':{IPA: 'ŋ', Symbols: 'ng/ㄫ ', Examples: '牙'},
     'h':{IPA: 'p', Symbols: 'b/ㄅ', Examples: '班'},
     'ʔ':{IPA: 'p̚', Symbols: '-p/-ㄆ', Examples: '濕'},
     't͡s':{IPA: 'pʰ', Symbols: 'p-/ㄆ-', Examples: '拍'},
     't͡ɕ':{IPA: 's', Symbols: 's/ㄙ/ㄒ', Examples: '西'},
     't͡sʰ':{IPA: 't', Symbols: 'd/ㄉ', Examples: '打'},
     't͡ɕʰ':{IPA: 't̚', Symbols: '-t/-ㄊ', Examples: '失'},
     's':{IPA: 'tʰ', Symbols: 't-/ㄊ-', Examples: '拖'},
     'ɕ':{IPA: 'ts', Symbols: 'z/ㄗ/ㄐ', Examples: '將'},
     'd͡z':{IPA: 'tsʰ', Symbols: 'c/ㄘ/ㄑ', Examples: '鏘'},
     'z':{IPA: 'w', Symbols: 'w/ㄨ', Examples: '活'},
     'd͡ʑ':{IPA: 'ŋ̩', Symbols: 'ng/ㄫ ', Examples: '五'},
     'ʑ':{IPA: 'ŋ̩', Symbols: 'ng/ㄫ ', Examples: '五'},
     'm̩':{IPA: 'ŋ̩', Symbols: 'ng/ㄫ ', Examples: '五'},
     'ŋ̍':{IPA: 'ŋ̩', Symbols: 'ng/ㄫ ', Examples: '五'},
     'p̚':{IPA: 'ŋ̩', Symbols: 'ng/ㄫ ', Examples: '五'},
     't̚':{IPA: 'ŋ̩', Symbols: 'ng/ㄫ ', Examples: '五'},
     'k̚':{IPA: 'ŋ̩', Symbols: 'ng/ㄫ ', Examples: '五'},
 },
 'empty':{
